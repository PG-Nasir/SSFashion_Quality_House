...
function submitAction() {
  ...
  for(let i = 0 ;i<length;i++){
    ...
    rollList += `autoId : ${id}@transferOutTransactionId : ${transferOutTransactionId}@purchaseOrder : ${purchaseOrder}@styleId : ${styleId}@styleNo : ${styleNo}@itemId : ${itemId}@itemName : ${itemName}@itemColorId : ${itemColorId}@itemColor : ${itemColor}@fabricsId : ${fabricsId}@fabricsName : ${fabricsName}@fabricsColorId : ${fabricsColorId}@fabricsColorName : ${fabricsColorName}@rollId : ${rollId}@supplierRollId : ${supplierRollId}@unitId : ${unitId}@unit : ${unit}@transferOutQty : ${transferOutQty}@rackName : ${rackName}@binName : ${binName}@qcPassedType : ${qcPassedType}@userId : ${userId} #`;
