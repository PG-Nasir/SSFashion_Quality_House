...
<div class="page-wrapper">
	...
	<div class="card-box">
		<header class="d-flex justify-content-between">
			<h5 class="text-center" style="display: inline;">General Store Item Returned</h5>
					...
					<tbody id="fabricsReceiveList">
								<c:forEach items="${receivedInvoiceList}" var="list"
										...
										<tr>
											...
											<td><i class="fa fa-print"  onclick="setGeneralReceivedInvoice(${list.invoiceNo},2)"> </i></td>
											<td><i class="fa fa-search" onclick="setGeneralReceivedInvoicedata(${list.invoiceNo},2)"> </i></td>
										</tr>
									</c:forEach>	
					</tbody>
				</table>
...
<script
	src="${pageContext.request.contextPath}/assets/js/store/general_return.js"></script>
